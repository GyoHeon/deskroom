...
export const ButtonWithLoading: React.FC<ButtonWithLoadingProps> = ({ shouldSubmit = true, children, ...props }) => {
  ...
  return (
    <Button type={shouldSubmit ? "submit" : "button"} className={`bg-primary-900 h-10 cursor-pointer ${pending && 'bg-gray-200'} ${props.className}`} disabled={pending} onClick={props.onClick}>
      {pending && (
        <div role="status">
