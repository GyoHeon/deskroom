  ...
  return (
    <>
      <Toast.Provider swipeDirection="up">
        <Toast.Root
          id="copy-toast"
          className="absolute w-full top-0 z-10 backdrop-blur-sm bg-[#3D5AFEBF]"
          open={toastOpen}
          onOpenChange={setToastOpen}>
          <Toast.Title className="flex items-center justify-center h-[41px] text-white">
            🎉 복사 완료 🎉
          </Toast.Title>
        </Toast.Root>
        <Toast.Viewport className="relative" />
